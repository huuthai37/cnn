...
if server:
    if train:
        out_file = '/home/oanhnt/thainh/data/database/train-opt1.pickle'
    else:
        out_file = '/home/oanhnt/thainh/data/database/test-opt1.pickle'
    valid_file = r'/home/oanhnt/thainh/data/database/valid-opt1.pickle'
else:
    if train:
        out_file = '/mnt/smalldata/database/train-opt1.pickle'
    else:
        out_file = '/mnt/smalldata/database/test-opt1.pickle'
    ...
    for e in range(epochs):
        ...
        if server:
            history = result_model.fit_generator(
                gd.getTrainData(keys,batch_size,classes,4,'train'), 
                verbose=1, 
                max_queue_size=2, 
                steps_per_epoch=len_samples/batch_size, 
                epochs=1,
                validation_data=gd.getTrainData(keys_valid,batch_size,classes,4,'valid'),
