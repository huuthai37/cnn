...
if train:
    if retrain:
        result_model.load_weights('weights/mobilenet_twostream2_io_{}e.h5'.format(old_epochs))
    ...
    for e in range(epochs):
        ...
        result_model.save_weights('weights/mobilenet_twostream2_io_{}e.h5'.format(old_epochs+1+e))

else:
    result_model.load_weights('weights/mobilenet_twostream2_io_{}e.h5'.format(epochs))
