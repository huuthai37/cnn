...
if train:
    ...
    for e in range(epochs):
        ...
        result_model.save_weights('weights/mobilenet_temporal1_{}e.h5'.format(old_epochs+1+e))

else:
    result_model.load_weights('weights/mobilenet_temporal1_{}e.h5'.format(epochs))
